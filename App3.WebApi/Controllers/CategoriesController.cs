...
namespace App3.WebApi.WebApi.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        private static readonly ActivitySource ActivitySource = new ActivitySource("App3.WebApi.WebApi.Controllers");
        ...
        [HttpGet]
        [ProducesResponseType(StatusCodes.Status200OK)]
        public async Task<IActionResult> GetAllWithSpan()
        {
            //var customActivitySource = new ActivitySource("InventoryBackgroundJob");
            using (var childActivity = ActivitySource.StartActivity("Get All Custom Span", ActivityKind.Internal))
            {
                var categories = await _categoryService.GetAll();
                return Ok(_mapper.Map<IEnumerable<CategoryResultDto>>(categories));
            }
